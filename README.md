...
<img src='https://github.com/dkimjpg/Parstagram/blob/master/walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Describe any challenges encountered while building the app.
Getting permissions to use the Parse database took me a while to figure out, but then I went to the dashboard and enabled read and write for all the posts.
